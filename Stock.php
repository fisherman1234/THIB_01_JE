...
mysql_select_db($database_localhost, $localhost);
$query_Detail = sprintf("SELECT * FROM Details WHERE Stock_ID = %s", GetSQLValueString($colname_Detail, "int"));
                      ...
                      <table align="center">
                        <tr valign="baseline">
                          ...
                          <td><span id="sprytextfield2">
                            <input type="text" name="Discussion_Date" value="" size="32" />
                        ...
                        <tr valign="baseline">
                          ...
                          <td><span id="sprytextfield1">
                            <input type="text" name="Alert_Date" value="" size="32" />
                            <span class="textfieldInvalidFormatMsg">Invalid format  (should be : yyyy-mm-dd)</span></span></td>
</tr>
                        <tr valign="baseline">
                        ...
                        <table align="center">
                          ...
                          <tr valign="baseline">
                            ...
                            <td><span id="sprytextfield5">
                              <input type="text" name="Meeting_Date" value="" size="32" />
                              <span class="textfieldInvalidFormatMsg">Invalid format. Should be yyyy-mm-dd</span></span></td>
                          </tr>
                          <tr valign="baseline">
              ...
              <div class="AccordionPanelContent">
                <table width="100%" border="1" align="center">
                  <tr>
                    ...
                    <td width="30%">Sector analysis title</td>
                    <td width="50%">Sector analysis text</td>
                  </tr>
                  <?php do { ?>
                    <tr>
                      <td><?php echo $row_Detail['Last_Entry_Date']; ?>&nbsp;</td>
                      <td><?php echo $row_Detail['Sector_Analysis_Title']; ?>&nbsp; </td>
                      <td><?php echo $row_Detail['Sector_Analysis_Text']; ?>&nbsp; </td>
                    </tr>
                    <?php } while ($row_Detail = mysql_fetch_assoc($Detail)); ?>
                </table>
                <br />
            ...
            <div class="AccordionPanel">
              ...
              <div class="AccordionPanelContent">
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form13" id="form13">
                  <table align="center">
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">Last entry date</td>
                      <td><span id="sprytextfield6">
                      <input type="text" name="Last_Entry_Date" value="" size="32" />
                      <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">Sector analysis title</td>
                      <td><input type="text" name="Sector_Analysis_Title" value="" size="32" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right" valign="top">Sector analysis text</td>
                      <td><textarea name="Sector_Analysis_Text" cols="50" rows="5"></textarea></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">&nbsp;</td>
                      <td><input type="submit" value="Insert record" /></td>
...
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextfield2", "date", {format:"yyyy-mm-dd", validateOn:["blur", "change"], isRequired:false});
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "date", {format:"yyyy-mm-dd", validateOn:["blur", "change"], isRequired:false});
...
var sprytextfield6 = new Spry.Widget.ValidationTextField("sprytextfield6", "date", {format:"yyyy-mm-dd", useCharacterMasking:true, validateOn:["blur"], hint:"yyyy-mm-dd"});
//-->
</script>
</body>
</html>
