...
$query_Rating = sprintf("SELECT * FROM Stocks, Sectors WHERE Stocks.Rating = %s AND Sectors.Sector_ID =Stocks.Sector_ID ORDER BY Stocks.In_Charge, Stocks.Stock_Name", GetSQLValueString($colname_Rating, "text"));
...
<title>Ratings : <?php echo $_GET['Rating']; ?></title>
...
<div id="container">
  <div id="header">
    <h1>Ratings : <?php echo $_GET['Rating']; ?></h1>
